...
<head>
    ...
    <title>Tạo bài thi - EduTest</title>
        ...
        <main class="member2-main">
            <nav class="member2-topbar">
                <div class="d-flex align-items-center">
                    ...
                    <div class="topbar-title">Tạo bài thi</div>
                </div>
            ...
            <section class="member2-page">
                <div class="page-header">
                    <div class="page-title-wrap">
                        <h1>Tạo bài thi</h1>
                        <div class="text-muted">Tạo bài đánh giá mới</div>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="grid-form">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ví dụ: Kiểm tra giữa kỳ - Lập trình" required>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Mô tả ngắn về bài thi"></textarea>
                            </div>
                        </div>

                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <a href="index.php" class="btn btn-secondary"><i class="fa-solid fa-xmark me-2"></i>Hủy</a>
                            <button type="button" class="btn btn-primary"><i class="fa-solid fa-plus me-2"></i>Tạo bài thi</button>
                        </div>
                    </form>
                </div>
            </section>
