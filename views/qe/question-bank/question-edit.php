...
<head>
    ...
    <title>Chỉnh sửa câu hỏi - EduTest</title>
...
<body>
    ...
    $answers = [
        ['answer_id' => 1, 'answer_text' => '$name', 'is_correct' => 1],
        ['answer_id' => 2, 'answer_text' => 'variable name', 'is_correct' => 0],
        ['answer_id' => 3, 'answer_text' => 'name =', 'is_correct' => 0],
        ['answer_id' => 4, 'answer_text' => 'declare $', 'is_correct' => 0],
    ];
    ?>
        ...
        <main class="member2-main">
            <nav class="member2-topbar">
                <div class="d-flex align-items-center">
                    ...
                    <div class="topbar-title">Chỉnh sửa câu hỏi</div>
                </div>
            ...
            <section class="member2-page">
                <div class="page-header">
                    <div class="page-title-wrap">
                        ...
                        <div class="text-muted">Cập nhật nội dung câu hỏi</div>
                    </div>
                ...
                <div class="form-wrap">
                    <form method="POST" action="../../controllers/QuestionBankController.php?action=updateQuestion&id=<?= $question['question_id'] ?>">
                        <div class="form-section">
                            ...
                            <div class="grid-form">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="bank_id" required>
                                        <?php foreach ($banks as $bank): ?>
                                            <option value="<?= $bank['bank_id'] ?>" <?= $bank['bank_id'] == $question['bank_id'] ? 'selected' : '' ?>><?= htmlspecialchars($bank['name']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="question_type" id="question_type" required>
                                        <option value="single_choice" <?= $question['question_type'] == 'single_choice' ? 'selected' : '' ?>>Trắc nghiệm một đáp án</option>
                                        <option value="multiple_choice" <?= $question['question_type'] == 'multiple_choice' ? 'selected' : '' ?>>Trắc nghiệm nhiều đáp án</option>
                                        <option value="fill_blank" <?= $question['question_type'] == 'fill_blank' ? 'selected' : '' ?>>Điền khuyết</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="difficulty">
                                        <option <?= $question['difficulty'] == 'Cơ bản' ? 'selected' : '' ?>>Cơ bản</option>
                                        <option <?= $question['difficulty'] == 'Trung bình' ? 'selected' : '' ?>>Trung bình</option>
                                        <option <?= $question['difficulty'] == 'Nâng cao' ? 'selected' : '' ?>>Nâng cao</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="status">
                                        <option <?= $question['status'] == 'Hoạt động' ? 'selected' : '' ?>>Hoạt động</option>
                                        <option <?= $question['status'] == 'Nháp' ? 'selected' : '' ?>>Nháp</option>
                                        <option <?= $question['status'] == 'Lưu trữ' ? 'selected' : '' ?>>Lưu trữ</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="explanation" rows="3" placeholder="Giải thích đáp án"><?= htmlspecialchars($question['explanation']) ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3" id="fill-blank-wrap" style="display: <?= $question['question_type'] == 'fill_blank' ? 'block' : 'none' ?>;">
                                <label class="form-label">Đáp án điền khuyết</label>
                                <input type="text" class="form-control" name="fill_blank_answer" placeholder="Ví dụ: 5" value="">
                            </div>

                            <div class="mb-3" id="essay-wrap" style="display: <?= $question['question_type'] == 'essay' ? 'block' : 'none' ?>;">
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fa-solid fa-floppy-disk me-2"></i>Lưu thay đổi</button>
                        </div>
                    </form>
                </div>
            </section>
